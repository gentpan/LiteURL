    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#09090b] text-[#fafafa] px-4">
      <div className="max-w-2xl text-center">
        ...
        <div className="flex gap-4 justify-center">
          <a href="https://github.com/miantiao-me/sink" className="px-6 py-3 bg-[#fafafa] text-[#18181b] rounded-lg font-medium hover:bg-[#e4e4e7] transition-colors" target="_blank" rel="noopener noreferrer">GitHub</a>
